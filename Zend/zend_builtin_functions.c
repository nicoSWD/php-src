...
static const zend_function_entry builtin_functions[] = { /* {{{ */
	...
	ZEND_FALIAS(function_num_args, func_num_args, arginfo_zend__void)
    ZEND_FE(func_get_arg,		arginfo_func_get_arg)
    ZEND_FE(func_get_args,		arginfo_zend__void)
	ZEND_FALIAS(func_args, func_get_args, arginfo_zend__void)
	ZEND_FALIAS(function_arg, func_get_arg, arginfo_zend__void)
    ZEND_FE(strlen,			arginfo_strlen)
	ZEND_FALIAS(str_len,	strlen, arginfo_strlen)
    ZEND_FE(strcmp,			arginfo_strcmp)
    ZEND_FALIAS(str_cmp,    strcmp, arginfo_strcmp)
    ZEND_FE(strncmp,		arginfo_strncmp)
    ZEND_FALIAS(str_ncmp,   strncmp, arginfo_strncmp)
    ZEND_FE(strcasecmp,		arginfo_strcmp)
    ZEND_FALIAS(str_case_cmp,   strcasecmp, arginfo_strcmp)
    ZEND_FE(strncasecmp,		arginfo_strncmp)
    ZEND_FALIAS(str_ncase_cmp, strncasecmp, arginfo_strncmp)
    ZEND_FE(each,			arginfo_each)
    ZEND_FE(error_reporting,	arginfo_error_reporting)
    ZEND_FE(define,			arginfo_define)
    ZEND_FE(defined,		arginfo_defined)
    ZEND_FE(get_class,		arginfo_get_class)
	ZEND_FALIAS(class_get,	get_class, arginfo_get_class)
    ZEND_FE(get_called_class, 	arginfo_zend__void)
	ZEND_FALIAS(class_called, get_called_class,	arginfo_zend__void)
    ZEND_FE(get_parent_class,	arginfo_get_class)
	ZEND_FALIAS(class_parent,   get_parent_class, arginfo_get_class)
	...
	ZEND_FALIAS(php_included_files, get_included_files,		arginfo_zend__void)
	ZEND_FALIAS(get_required_files,	get_included_files,		arginfo_zend__void)
	ZEND_FALIAS(php_required_files, get_included_files,		arginfo_zend__void)
	...
	ZEND_FALIAS(class_vars, get_class_vars, arginfo_get_class_vars)
    ZEND_FE(get_object_vars,	arginfo_get_object_vars)
	ZEND_FALIAS(class_object_vars, get_object_vars, arginfo_get_object_vars)
    ZEND_FE(get_class_methods,	arginfo_get_class_methods)
	ZEND_FALIAS(class_methods,  get_class_methods, arginfo_get_class_methods)
	...
	ZEND_FALIAS(class_declared,		get_declared_classes, arginfo_zend__void)
    ZEND_FE(get_declared_traits, 		arginfo_zend__void)
	ZEND_FALIAS(trait_declared,			get_declared_traits, arginfo_zend__void)
    ZEND_FE(get_declared_interfaces, 	arginfo_zend__void)
	ZEND_FALIAS(interface_declared, get_declared_interfaces, arginfo_zend__void)
    ZEND_FE(get_defined_functions, 		arginfo_zend__void)
	ZEND_FALIAS(function_declared, get_declared_interfaces, arginfo_zend__void)
    ZEND_FE(get_defined_vars,		arginfo_zend__void)
	ZEND_FALIAS(php_defined_vars,	get_defined_vars, arginfo_zend__void)
    ZEND_FE(create_function,		arginfo_create_function)
	ZEND_FALIAS(function_create, create_function, arginfo_create_function)
    ZEND_FE(get_resource_type,		arginfo_get_resource_type)
    ZEND_FE(get_resources,			arginfo_get_resources)
    ZEND_FE(get_loaded_extensions,		arginfo_get_loaded_extensions)
	ZEND_FALIAS(php_extension_loaded_all, get_loaded_extensions, arginfo_get_loaded_extensions)
    ZEND_FE(extension_loaded,		arginfo_extension_loaded)
	ZEND_FALIAS(php_extension_loaded, extension_loaded, arginfo_extension_loaded)
    ZEND_FE(get_extension_funcs,		arginfo_extension_loaded)
	ZEND_FALIAS(php_extension_functions, get_extension_funcs, arginfo_extension_loaded)
    ZEND_FE(get_defined_constants,		arginfo_get_defined_constants)
	ZEND_FALIAS(php_defined_constants,	get_defined_constants, arginfo_get_defined_constants)
