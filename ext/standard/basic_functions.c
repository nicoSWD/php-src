...
ZEND_BEGIN_ARG_INFO_EX(arginfo_array_in, 0, 0, 2)
ZEND_ARG_INFO(0, haystack) /* ARRAY_INFO(0, haystack, 0) */
ZEND_ARG_INFO(0, needle)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_array_find, 0, 0, 2)
ZEND_ARG_INFO(0, haystack) /* ARRAY_INFO(0, haystack, 0) */
ZEND_ARG_INFO(0, needle)
ZEND_ARG_INFO(0, strict)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO(arginfo_array_key_find, 0)
ZEND_ARG_INFO(0, search)
ZEND_ARG_INFO(0, key)
ZEND_END_ARG_INFO()
...
const zend_function_entry basic_functions[] = { /* {{{ */
	...
	PHP_FALIAS(str_word_wrap,		wordwrap,								arginfo_wordwrap)
	PHP_FE(htmlspecialchars,												arginfo_htmlspecialchars)
	PHP_FALIAS(html_escape,			htmlspecialchars,						arginfo_htmlspecialchars)
	PHP_FE(htmlentities,													arginfo_htmlentities)
	PHP_FALIAS(html_entities,		htmlentities,							arginfo_htmlentities)
	PHP_FE(html_entity_decode,												arginfo_html_entity_decode)
	PHP_FE(htmlspecialchars_decode,											arginfo_htmlspecialchars_decode)
	PHP_FALIAS(html_escape_decode,  htmlspecialchars_decode,				arginfo_htmlspecialchars_decode)
	PHP_FE(get_html_translation_table,										arginfo_get_html_translation_table)
	PHP_FALIAS(html_translation_table, get_html_translation_table,			arginfo_get_html_translation_table)
	...
	PHP_FALIAS(str_spn,				strspn,									arginfo_strspn)
	PHP_FE(strcspn,															arginfo_strcspn)
	PHP_FALIAS(str_cspn,			strcspn,								arginfo_strcspn)
	PHP_FE(strtok,															arginfo_strtok)
	PHP_FALIAS(str_tok,				strtok,									arginfo_strtok)
	PHP_FE(strtoupper,														arginfo_strtoupper)
	PHP_FALIAS(str_to_upper,		strtoupper,								arginfo_strtoupper)
	PHP_FE(strtolower,														arginfo_strtolower)
	PHP_FALIAS(str_to_lower,		strtolower,								arginfo_strtolower)
	PHP_FE(strpos,															arginfo_strpos)
	PHP_FALIAS(str_pos,				strpos,									arginfo_strpos)
	PHP_FE(stripos,															arginfo_stripos)
	PHP_FALIAS(str_ipos,			stripos,								arginfo_stripos)
	PHP_FE(strrpos,															arginfo_strrpos)
	PHP_FALIAS(str_rpos,			strrpos,								arginfo_strrpos)
	PHP_FE(strripos,														arginfo_strripos)
	PHP_FALIAS(str_ripos,			stripos,								arginfo_strripos)
	PHP_FE(strrev,															arginfo_strrev)
	PHP_FALIAS(str_rev,				strrev,									arginfo_strrev)
	...
	PHP_FALIAS(str_cslashes_strip,  stripcslashes,							arginfo_stripcslashes)
	PHP_FE(strstr,															arginfo_strstr)
	PHP_FALIAS(str_chr,				strstr,									arginfo_strstr)
	PHP_FE(stristr,															arginfo_stristr)
	PHP_FALIAS(str_istr,			stristr,								arginfo_stristr)
	...
	PHP_FALIAS(str_pbrk,			strpbrk,								arginfo_strpbrk)
	...
	PHP_FALIAS(str_money_format,	money_format,							arginfo_money_format)
#endif

	PHP_FE(substr,															arginfo_substr)
	PHP_FE(substr_replace,													arginfo_substr_replace)
	PHP_FE(quotemeta,														arginfo_quotemeta)
	PHP_FALIAS(str_quote_meta,		quotemeta,								arginfo_quotemeta)
	PHP_FE(ucfirst,															arginfo_ucfirst)
	PHP_FALIAS(str_uc_first,		ucfirst,								arginfo_ucfirst)
	PHP_FE(lcfirst,															arginfo_lcfirst)
	PHP_FALIAS(str_lc_first,		lcfirst,								arginfo_lcfirst)
	PHP_FE(ucwords,															arginfo_ucwords)
	PHP_FALIAS(str_uc_words,		ucwords,								arginfo_ucwords)
	PHP_FE(strtr,															arginfo_strtr)
	PHP_FALIAS(str_tr,				strtr,									arginfo_strtr)
	PHP_FE(addslashes,														arginfo_addslashes)
	PHP_FALIAS(str_slashes,			addslashes,								arginfo_addslashes)
	PHP_FE(addcslashes,														arginfo_addcslashes)
	PHP_FALIAS(str_cslashes,		addcslashes,							arginfo_addcslashes)
	PHP_FE(rtrim,															arginfo_rtrim)
	PHP_FALIAS(str_rtrim,			rtrim,									arginfo_rtrim)
	...
	PHP_FALIAS(str_count_chars,		count_chars,							arginfo_count_chars)
	PHP_FE(chunk_split,														arginfo_chunk_split)
	PHP_FALIAS(str_chunk_split,		chunk_split,							arginfo_chunk_split)
	PHP_FE(trim,															arginfo_trim)
	PHP_FALIAS(str_trim,			trim,									arginfo_rtrim)
	PHP_FE(ltrim,															arginfo_ltrim)
	PHP_FALIAS(str_ltrim,			ltrim,									arginfo_ltrim)
	PHP_FE(strip_tags,														arginfo_strip_tags)
	PHP_FALIAS(html_strip_tags,		strip_tags,								arginfo_strip_tags)
	PHP_FE(similar_text,													arginfo_similar_text)
	PHP_FALIAS(str_similar_text,	similar_text,							arginfo_similar_text)
	PHP_FE(explode,															arginfo_explode)
	PHP_FALIAS(str_explode,			explode,								arginfo_explode)
	...
	PHP_FALIAS(str_soundex,			soundex,								arginfo_soundex)
	PHP_FE(levenshtein,														arginfo_levenshtein)
	PHP_FALIAS(str_levenshtein,		levenshtein,							arginfo_levenshtein)
	...
	PHP_FALIAS(exec_escape_arg,		escapeshellcmd,							arginfo_escapeshellcmd)
	PHP_FE(escapeshellarg,													arginfo_escapeshellarg)
	PHP_FALIAS(exec_escape_cmd,		escapeshellarg,							arginfo_escapeshellarg)
	PHP_FE(passthru,														arginfo_passthru)
	PHP_FALIAS(exec_passthru,		passthru,								arginfo_passthru)
	PHP_FE(shell_exec,														arginfo_shell_exec)
	PHP_FALIAS(exec_shell,			shell_exec,								arginfo_shell_exec)
#ifdef PHP_CAN_SUPPORT_PROC_OPEN
	...
	PHP_FALIAS(str_number_format,   number_format,						  arginfo_number_format)
...
# endif
	...
	PHP_FALIAS(str_metaphone,				metaphone,						arginfo_metaphone)
	...
	PHP_FE(array_in,														arginfo_array_in)
	...
	PHP_FE(array_key_find,													arginfo_array_key_find)

	/* aliases from array.c */
	PHP_FALIAS(pos,							current,						arginfo_current)
	PHP_FALIAS(sizeof,						count,							arginfo_count)
	PHP_FALIAS(array_shuffle,				shuffle,						arginfo_shuffle)
	PHP_FALIAS(array_sort_ukey,				uksort,							arginfo_uksort)
	PHP_FALIAS(key_exists,					array_key_exists,				arginfo_array_key_exists)
	PHP_FALIAS(array_range,					range,							arginfo_range)
	PHP_FALIAS(array_compact,				compact,						arginfo_compact)
	PHP_FALIAS(array_extract,				extract,						arginfo_extract)
	PHP_FALIAS(array_sort_uassoc,			uasort,							arginfo_uasort)
	PHP_FALIAS(array_usort,					usort,							arginfo_usort)
	PHP_FALIAS(array_sort_reverse,			rsort,							arginfo_rsort)
	PHP_FALIAS(array_sort,					sort,							arginfo_sort)
	PHP_FALIAS(array_sort_assoc_reverse,	arsort,							arginfo_arsort)
	PHP_FALIAS(array_sort_natural_case,		natcasesort,					arginfo_natcasesort)
	PHP_FALIAS(array_sort_assoc,			asort,							arginfo_asort)
	PHP_FALIAS(array_sort_key,				ksort,							arginfo_ksort)
	PHP_FALIAS(array_sort_natural,			natsort,						arginfo_natsort)
	PHP_FALIAS(array_sort_key_reverse,		krsort,							arginfo_krsort)
