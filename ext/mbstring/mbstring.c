...
const zend_function_entry mbstring_functions[] = {
    ...
    PHP_FALIAS(mb_str_to_upper, mb_strtoupper, arginfo_mb_strtoupper)
	PHP_FE(mb_strtolower,			arginfo_mb_strtolower)
    PHP_FALIAS(mb_str_to_lower, mb_strtolower, arginfo_mb_strtolower)
    ...
    PHP_FALIAS(mb_str_len, mb_strlen, arginfo_mb_strlen)
	PHP_FE(mb_strpos,				arginfo_mb_strpos)
    PHP_FALIAS(mb_str_pos, mb_strpos, arginfo_mb_strpos)
	PHP_FE(mb_strrpos,				arginfo_mb_strrpos)
    PHP_FALIAS(mb_str_rpos, mb_strrpos, arginfo_mb_strrpos)
	PHP_FE(mb_stripos,				arginfo_mb_stripos)
    PHP_FALIAS(mb_str_ipos, mb_stripos, arginfo_mb_stripos)
	PHP_FE(mb_strripos,				arginfo_mb_strripos)
    PHP_FALIAS(mb_str_ripos, mb_strripos, arginfo_mb_strripos)
	PHP_FE(mb_strstr,				arginfo_mb_strstr)
    PHP_FALIAS(mb_str_str, mb_strstr, arginfo_mb_strstr)
	PHP_FE(mb_strrchr,				arginfo_mb_strrchr)
    PHP_FALIAS(mb_str_rchr, mb_strrchr, arginfo_mb_strrchr)
	PHP_FE(mb_stristr,				arginfo_mb_stristr)
    PHP_FALIAS(mb_str_istr, mb_stristr, arginfo_mb_stristr)
	PHP_FE(mb_strrichr,				arginfo_mb_strrichr)
    PHP_FALIAS(mb_str_richr, mb_strrichr, arginfo_mb_strrichr)
	PHP_FE(mb_substr_count,			arginfo_mb_substr_count)
	PHP_FE(mb_substr,				arginfo_mb_substr)
	PHP_FE(mb_strcut,				arginfo_mb_strcut)
    PHP_FALIAS(mb_str_cut, mb_strcut, arginfo_mb_strcut)
	PHP_FE(mb_strwidth,				arginfo_mb_strwidth)
    PHP_FALIAS(mb_str_width, mb_strwidth, arginfo_mb_strwidth)
	PHP_FE(mb_strimwidth,			arginfo_mb_strimwidth)
    PHP_FALIAS(mb_str_trim_width, mb_strimwidth, arginfo_mb_strimwidth)
